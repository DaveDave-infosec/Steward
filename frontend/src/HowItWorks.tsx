  ...
  return (
    <div className="howto">
      ...
      <section className="howto-block">
        ...
        <p><strong>Execution relay.</strong> In V1 the verifier's verdict is relayed into the reserve by an owner-or-creator call rather than an automatic contract-to-contract trigger. The verdict values — fulfilment percentage and outcome — come only from validator consensus; the relayer cannot change them, and the verdict and its execution are recorded against the same case id for audit. A fully trustless verifier-to-reserve bridge is the V2 target.</p>

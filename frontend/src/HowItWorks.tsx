  ...
  return (
    <div className="howto">
      ...
      <section className="howto-block">
        ...
        <p><strong>Settlement is bound to the verdict.</strong> Settlement is not driven by caller-supplied data. To settle a checkpoint, apply_verdict is given only a case id; the reserve reads that verdict directly from the verifier contract on-chain, confirms it was produced against this checkpoint's locked evidence source and criteria, authenticates the transaction sender, and moves capital strictly by the verifier's stored fulfilment percentage and outcome. A relayer cannot fake the number, spoof an identity, or point at a different repository. A relaying transaction still triggers the read today; a fully event-driven trigger is a later refinement.</p>
